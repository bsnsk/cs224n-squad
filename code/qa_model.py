...
from modules import RNNEncoder, SimpleSoftmaxLayer, BasicAttn, CoAttn, CoAttn2
...
class QAModel(object):
    ...
    def build_graph(self):
        ...
        attn_layer = CoAttn2(self.keep_prob, self.FLAGS.hidden_size*2, self.FLAGS.hidden_size*2)
